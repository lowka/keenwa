...
impl RequiredProperties {
    ...
    // TODO: Move to enforcers module.
    pub fn get_global_properties(&self) -> Option<RequiredProperties> {
        self.partitioning.clone().map(RequiredProperties::new_with_partitioning)
    }

    pub fn into_partitioning(self) -> Option<Partitioning> {
        self.partitioning
    }
}
